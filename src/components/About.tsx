export default function About() {
  return (
    <section className="py-20 px-6 bg-dark-50 border-t border-dark-100">
      <div className="max-w-3xl mx-auto text-center">
        <p className="text-primary-600 font-semibold text-sm uppercase tracking-wide mb-3">About FlowgentX</p>
